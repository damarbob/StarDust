...
- **MySQL 8.0.13+ or MariaDB 10.11+, detected not configured.** MariaDB older
  than 10.11, and MySQL/Percona older than 8.0.13, are rejected and a CI job asserts the suite
